          ...
          {step === "form" && (
            <>
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-slate-900">Confirmar Doação</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1.5">Nome Completo <span className="text-red-500">*</span></label>
                  <input
                    type="text"
                    required
                    value={name}
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1.5">WhatsApp <span className="text-slate-400 font-normal">(Opcional)</span></label>
                  <input
                    type="text"
                    value={phone}
