        ...
        <div className="w-fit">
          ...
          <div className="space-y-2 text-sm">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <svg className="shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="#1877f2">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <svg className="shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#db2777" strokeWidth="2">
